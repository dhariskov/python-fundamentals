...
for ticket in tickets:
    ...
    if len(ticket) != 20:
        ...
        elif (("^" * 6) not in ticket[0:10]) or (("^" * 6) not in ticket[10:20]) or (("#" * 6) not in ticket[0:10]) or (("#" * 6) not in ticket[10:20]) or (("$" * 6) not in ticket[0:10]) or (("$" * 6) not in ticket[10:20]) or (("@" * 6) not in ticket[0:10]) or (("@" * 6) not in ticket[10:20]):
